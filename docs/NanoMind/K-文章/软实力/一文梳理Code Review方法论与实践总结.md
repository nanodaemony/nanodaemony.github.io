...
![](/zimg/yuque-1778165508551-1.png)
...
- **性能隐患**：是否存在**损害性能的隐患**，如死锁、死循环、FullGC、慢 SQL、缓存数据热点等。
...
笔者对个人 CR 评论问题做了个大概统计，Bug 发现数占比约 4%（直接或潜在 Bug），重复代码数占比约 5%，其他还有规范、安全、性能、设计等问题。在 CR 代码质量时，可以参考《重构：改善既有代码的设计》，书中所列的 22 种坏味道在 CR 中基本都会遇到。而此处主要聚焦以下几个常见问题：
...
![](/zimg/yuque-1778165508562-2.png)
